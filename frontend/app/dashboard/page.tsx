    ...
    <div className="min-h-[calc(100vh-80px)] bg-background">
      <div className="section-horizontal section-vertical max-w-7xl mx-auto">
        ...
        >
          <div className="lg:col-span-3 glass-premium p-10 rounded-[3rem] relative overflow-hidden group border-white/10">
            ...
            <div className="relative z-10">
              ...
              <div className="w-full h-3 bg-muted/30 rounded-full overflow-hidden mb-6 border border-ui-border/10 p-0.5">
                <div
                  className="h-full bg-gradient-to-r from-orange-500 via-orange-500 to-yellow-500 rounded-full transition-all duration-1000 ease-out shadow-[0_0_15px_rgba(255,127,0,0.5)]"
          ...
          <div
            className="glass-premium p-10 rounded-[3rem] flex flex-col justify-between border-white/10 hover:border-orange-500/40 transition-all duration-500 group cursor-pointer"
            onClick={() => setShowAddModal(true)}
          >
            <div>
              <div className="w-16 h-16 rounded-[1.5rem] bg-orange-500 text-white flex items-center justify-center mb-8 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-xl shadow-orange-500/20">
            ...
            <div className="mt-8 flex items-center gap-2 text-orange-500 text-sm font-black uppercase tracking-widest group-hover:translate-x-2 transition-transform">
          ...
          <div className="relative glass-premium w-full max-w-xl rounded-[3.5rem] p-10 md:p-14 border border-white/20 shadow-[0_50px_100px_rgba(0,0,0,0.4)] animate-in zoom-in-95 duration-500">
            <div className="flex items-center justify-between mb-12">
              <div className="flex items-center gap-5">
                <div className="w-14 h-14 rounded-2xl bg-orange-500 text-white flex items-center justify-center shadow-2xl shadow-orange-500/30">
                  {editingTodo ? (
            ...
            >
              <div className="space-y-3">
                ...
                <Input
                  ...
                  autoFocus
                  required
                  className="h-16 rounded-2xl bg-muted/30 text-xl border-2 border-transparent focus:border-orange-500/50 transition-all shadow-inner font-bold"
                />
              </div>
              ...
              <div className="space-y-3">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full rounded-2xl px-6 py-5 bg-muted/30 text-lg border-2 border-transparent focus:border-orange-500/50 transition-all resize-none outline-none shadow-inner font-medium placeholder:opacity-50"
                />
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6">
                ...
                <Button
                  ...
                  variant="primary"
                  fullWidth
                  className="h-16 rounded-[1.75rem] font-black text-sm uppercase tracking-widest shadow-[0_20px_40px_rgba(255,127,0,0.3)] group"
                >
