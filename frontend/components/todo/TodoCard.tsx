        ...
        <div className="flex items-start justify-between gap-4 mb-4">
            ...
            <button
              ...
              className={cn(
                ...
                todo.completed
                  ...
                  : "border-muted-foreground/30 hover:border-orange-500 group-hover:scale-105",
              )}
            >
          ...
          <div className="flex gap-2">
            <Button
              ...
              size="sm"
              onClick={handleEdit}
              className="w-8 h-8 p-0 rounded-full hover:bg-orange-500/10 hover:text-orange-500"
            >
