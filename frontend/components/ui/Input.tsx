          ...
          <label
            className={cn(
              ...
              hasError
                ...
                : "text-slate-700 dark:text-slate-300 group-focus-within:text-orange-600 dark:group-focus-within:text-orange-500",
            )}
          >
            {label}
          </label>
        ...
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              ...
              // T021: Focus glow - ring-2 ring-orange-500/20
