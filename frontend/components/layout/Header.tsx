          ...
          <div className="flex items-center gap-4">
            ...
            {!pathname?.includes("/dashboard") && (
              <Link href="/dashboard" className="hidden sm:block">
                <button className="px-5 py-2.5 bg-primary text-white text-sm font-black rounded-xl hover:bg-orange-600 transition-all active:scale-95 shadow-lg shadow-orange-500/30">
                  Go to Workspace
                </button>
              </Link>
            )}
